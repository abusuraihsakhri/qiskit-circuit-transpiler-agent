"""
Data Models & Telemetry Definitions for Quantum Circuit Transpilation & CNOT Gate Optimizer Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "OpenQASM 3.0 / Qiskit Transpiler Standard"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
